 ...
 */
THREEx.Terrain.allocateHeightMap	= function(width, depth){ // Creates the Phsycial Area of the Map
 ...
 */
THREEx.Terrain.simplexHeightMap	= function(heightMap){ // Generates the Values/Noise for the Map
...
THREEx.Terrain.heightMapToPlaneGeometry	= function(heightMap){
	...
	var width	= heightMap.length
	var depth	= heightMap[0].length
	console.log(JSON.stringify(heightmap.height));
	// build geometry
